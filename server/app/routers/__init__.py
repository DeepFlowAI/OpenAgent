...
def register_routers(app: FastAPI) -> None:
    ...
    app.include_router(agent_message_preprocessing_rule.router, prefix="/api/v1")
    app.include_router(api_key.router, prefix="/api/v1")
    app.include_router(conversation.router, prefix="/api/v1")
    app.include_router(conversation_report.router, prefix="/api/v1")
    app.include_router(conversation_step.router, prefix="/api/v1")
    app.include_router(conversation_inspection.router, prefix="/api/v1")
